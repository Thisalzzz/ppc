    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-3">Available Spaces</h1>
              ...
              >
                ...
                <div className="px-6 pb-6">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-medium py-3 px-4 rounded-xl transition-colors duration-300 shadow-md hover:shadow-lg"
                  >
        ...
        {!isLoading && rooms.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="mt-4 text-xl font-medium text-gray-900">No rooms available</h3>
