...
import aristocraticImg from "../../assets/property-details/artistocratic.jpg";
import furnishedImg from "../../assets/property-details/furnished.jpg";
import rajagiriya from "../../assets/properties/rajagiriya.jpg";
...
const PropertyDetails = () => {
  ...
  const images = [
    ...
    { src: furnishedImg, alt: "Furnished and Unfurnished Options" },
  ];
  ...
  return (
    <div className="w-full bg-[#111111] font-inter text-gray-200">
      <Navbar />
    ...
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-gray-900">
      ...
      <div 
        ref={backgroundRef}
        className="absolute inset-0 bg-center bg-cover transition-transform duration-30000"
        style={{ 
          backgroundImage: `url(${rajagiriya})`,
      ...
      {/* Floating content with modern design */}
      <div className="relative z-10 text-center max-w-4xl px-6 py-12 backdrop-blur-xl bg-black/30 border border-white/10 rounded-2xl shadow-2xl transform transition-all duration-700 animate-float">
        <h1 className="text-5xl md:text-6xl font-playfair text-white font-bold leading-tight tracking-tight">
          <span className="bg-gradient-to-r from-purple-400 via-pink-400 to-pink-500 bg-clip-text text-transparent">
            Paradise Properties Ceylon
          </span>
        </h1>
        
        <div className="w-40 h-1 bg-gradient-to-r from-purple-500 via-pink-500 to-pink-400 mx-auto my-6 rounded-full" />
        
        <p className="text-gray-300 mt-4 text-xl md:text-2xl font-light max-w-2xl mx-auto tracking-wider">
      ...
      {[...Array(15)].map((_, i) => (
        <div 
          ...
          style={{
            ...
            background: i % 3 === 0 ? 'rgb(192, 132, 252)' : i % 3 === 1 ? 'rgb(249, 168, 212)' : 'rgb(236, 72, 153)',
            top: `${Math.random() * 100}%`,
      ...
      <style jsx>{`
        ...
        @keyframes float-particle {
          ...
          75% { transform: translateY(-60px) translateX(5px); }
    ...
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
      ...
      <section id="map" className="max-w-6xl mx-auto px-4 mt-16" data-aos="fade-up">
        ...
        <div className="rounded-2xl overflow-hidden shadow-2xl h-[400px] border border-gray-800">
          <iframe
            title="Map"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.8800637287777!2d79.89569617475685!3d6.904942993094408!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae259b7dad2974b%3A0x23e5897761c3bed8!2sParadise%20Properties%20Ceylon!5e0!3m2!1sen!2slk!4v1753335779458!5m2!1sen!2slk" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen=""
