...
const FeaturesSection = () => {
  const features = [
    ...
    { icon: <FaUsers size={30} />, title: "Both furnished and unfurnished", color: "from-blue-400 to-blue-600" },
    ...
    { icon: <FaHandsHelping size={30} />, title: "Equipped with support staff", color: "from-orange-400 to-orange-600" },
